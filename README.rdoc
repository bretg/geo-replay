...
The Rails application should work in it's current framework state to play around with the edit and display functionality.

To get a sense for what a GeoReplay might look like:
1. checkout the tree from GitHub
2. edit lib/assets/javascripts/replay.js and change assetPath to ../assets
3. open public/pony_demo.html in a browser.
