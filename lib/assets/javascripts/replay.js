...
controlUI.innerHTML="<img src='/assets/play.png' />";
...
speedUpUI.innerHTML="<img src='/assets/up_tri.png' />";
...
speedDownUI.innerHTML="<img src='/assets/down_tri.png' />";
...
function animControl() {
   if (pause==0) {
	...
	pause=0;
	controlUI.innerHTML="<img src='/assets/pause.png' />";
